...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JButton write = new JButton("Print a random number on the interface");
        final JPanel panel = new JPanel();
        panel.setLayout(new BoxLayout(panel, javax.swing.BoxLayout.X_AXIS));
        canvas.add(panel, BorderLayout.CENTER);
        panel.add(write);
        final JTextField result = new JTextField("0");
